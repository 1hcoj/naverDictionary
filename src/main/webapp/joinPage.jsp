...
<script>
  function checkForm(){
    let form = document.joinForm.value;
...
<body>
  <div id="header" role="banner">
    <p><a href="loginPage.jsp">Home</a></p>
  </div>
    ...
    <div id="container" role="main">
      <form name="joinForm" method="post" action="joinCheck.jsp">
        <div id="joinName" role="inputName">
          ...
          <p><input type="button" id="checkDuplicateBtn" value="아이디 중복 검사"></p>

        </div>
        <div id="joinId" role="inputId">
          <p>아이디</p>
          <input type="text" name="userId" placeholder="영문,숫자 조합" class="input"/>
        </div>
        ...
        <input type="button" id = "buttonJoin" onclick="" value="회원가입">
      </form>
    </div>
  </div>
